...
uint256 hashGenesisBlock("0x5c7a12deb99cf57d18f7b677e8afe7808dca467f7671a0d6f7c9b5f0e8593007");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Dzcoin: starting difficulty is 1 / 2^12
...
{
    // Dzcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1000); // Dzcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // Dzcoin: 3.5 days
static const int64 nTargetSpacing =  1 * 30; // Dzcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Dzcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Dzcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5c7a12deb99cf57d18f7b677e8afe7808dca467f7671a0d6f7c9b5f0e8593007");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "dzcoin  is coin algerian ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("302584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1527183144;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386184199;
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xc58e339fce4c95b129d4b1c7e31d4554080e97b0eabde62ab7e4ec531ec15dfa"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf5, 0xc8, 0xb1, 0xd6 }; // Dzcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DzcoinMiner : ProcessBlock, block not accepted");
    }
...
void static DzcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running DzcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
